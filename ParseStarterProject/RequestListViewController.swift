...
class RequestListViewController: UITableViewController, CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        if let location = manager.location?.coordinate {
            ...
            driverLocationQuery.whereKey("Username", equalTo: PFUser.current())
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let roundedDistace = round(distance * 100) / 100
        
        cell.textLabel?.text = requestUsernames[indexPath.row] + " - \(roundedDistace) km away"
